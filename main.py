...
def display_worker(lock, data):
    ...
    button_loggin = tk.Button(root, text="Logging", command=logging_button_handler)
    button_loggin.grid(row=3, column=0)
    button_darkmode = tk.Button(root, text="DarkMode", command=darkmode_button_handler)
    button_darkmode.grid(row=3, column=1, text="DarkMode")
